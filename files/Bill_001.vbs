...
Function LoadBill(objDb,objRs,objBk,byVal strJGyobu,byVal strSheetName)
	...
	for lngRow = lngRowTop to lngRowMax
		...
		case "B"	'⑦部内出庫
			...
			objRs.Fields("AnyKbn") 		= RTrim(objSt.Range("P" & lngRow))									'// 区分
