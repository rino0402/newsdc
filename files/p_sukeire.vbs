...
sqlStr = "select *"
sqlStr = sqlStr & " from p_sukeire"
sqlStr = sqlStr & " where SHIMUKE_CODE = '04'"
sqlStr = sqlStr & " and UKEIRE_DT >= '20110621'"
...
rsDstPSShijiO.Open "p_sukeire", dbDst, adOpenKeyset, adLockBatchOptimistic, adCmdTableDirect
...
Do While Not rsSrcPSShijiO.EOF
	...
	strBuff = strBuff & " " & rsSrcPSShijiO.Fields("UKEIRE_DT")
