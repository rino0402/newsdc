...
Class Dish2
    ...
    Private Function Usage(byval lErr,byval sErr)
		Call Debug("Dish2.Usage()")
		lngErr	= lErr
		strErr	= sErr
		Wscript.Echo "食洗移管"
		Wscript.Echo "Dish2.vbs [option]"
		Wscript.Echo " /db:dns"
		...
		Wscript.Echo " /copy"
		Wscript.Echo "Ex."
		Wscript.Echo "cscript Dish2.vbs /db:newsdc6"
		Call DispMsg(strErr)
		Usage = lngErr
    End Function
    ...
    Private Sub Class_Initialize
		Call Debug("Dish2.Class_Initialize()")
    ...
    Private Sub Class_Terminate
		Call Debug("Dish2.Class_Terminate()")
		Call CloseDB()
    End Sub
	...
	Private Function	OpenDB()
		Call Debug("Dish2.OpenDb():" & strDBName)
    ...
    Private Function CloseDB()
		Call Debug("Dish2.CloseDB():" & strDBName)
