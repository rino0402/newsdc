...
rsDstPSHOrder.Open "p_shuriage", dbDst, adOpenKeyset, adLockBatchOptimistic, adCmdTableDirect
...
Do While Not rsSrcPSHOrder.EOF
	...
	strBuff = "SRC"
	strBuff = strBuff & " " & rsSrcPSHOrder.Fields("URIAGE_NO")
	...
	for each f in rsSrcPSHOrder.Fields
		...
		case "URIAGE_NO"
			...
			case "0"
				rsDstPSHOrder.Fields(f.Name) = "1" & right(f,4)
			case "1"
